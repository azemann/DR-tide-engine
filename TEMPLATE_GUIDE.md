...
Ne placez pas l’état présent dans ces manifestes : il appartient à `PROJECT_STATE.md`.
...
## 9. Séparer développement, release et distribution
...
## 11. Maintenir les sources de vérité

- `README.md` : identité durable ;
- `PROJECT_STATE.md` : présent opérationnel et reprise ;
...
La v1.6 améliore l’expérience d’adoption. Elle n’ajoute ni générateur multi-fournisseur, ni moteur universel de commandes.
