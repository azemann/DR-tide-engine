...
Le contrôle devient progressif et cumulatif. Les placeholders ne sont recherchés que dans les documents actifs. Un diagnostic en lecture seule précède toute intégration d’un dépôt existant.
